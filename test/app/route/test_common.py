...
@pytest.mark.parametrize(
    'TEST_raster_path, TEST_vector_path, expected_mean, expected_min, expected_max',
    [
        (
            TEST_raster_path,
            TEST_vector_path,
...
def test_aggregate_raster_response(TEST_raster_path, TEST_vector_path, expected_mean, expected_min, expected_max):
